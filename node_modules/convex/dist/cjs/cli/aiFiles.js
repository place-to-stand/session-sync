...
var import_ai = require("./lib/ai/index.js");
...
const aiInstall = new import_extra_typings.Command("install").summary("Install or refresh Convex AI files").description(
  ...
  await (0, import_ai.updateAiFiles)(projectDir, convexDir);
});
const aiEnable = new import_extra_typings.Command("enable").summary("Enable Convex AI file staleness/install messages").description(
  ...
  const { projectDir, convexDir } = await resolveProjectPaths();
  await (0, import_ai.enableAiFiles)(projectDir, convexDir);
});
...
const aiDisable = new import_extra_typings.Command("disable").summary("Suppress AI file staleness/install messages without removing files").description(
  ...
  await (0, import_ai.disableAiFiles)(projectDir);
});
const aiStatus = new import_extra_typings.Command("status").summary("Show the current status of Convex AI files").description(
  ...
  const { projectDir, convexDir } = await resolveProjectPaths();
  await (0, import_ai.statusAiFiles)(projectDir, convexDir);
});
const aiRemove = new import_extra_typings.Command("remove").summary("Remove all Convex AI files from the project").description(
  ...
  const { projectDir, convexDir } = await resolveProjectPaths();
  await (0, import_ai.removeAiFiles)(projectDir, convexDir);
});
